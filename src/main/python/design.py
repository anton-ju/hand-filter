...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBoxBiFrom.setProperty("value", 0)
        ...
        self.spinBoxBiTo.setProperty("value", 999)
